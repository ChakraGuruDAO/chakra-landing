...
export const discordUrl = "https://discord.gg/FtvwdzHhkK";
export const githubUrl = "https://github.com/ChakraGuruDAO";
export const mediumUrl = "https://chakraguru.medium.com/";
