...
export const ArinaKanivets = {
  ...
  role: "UI/UX Lead",
  description:
    "Web & Mobile designer. International market experience and team building. Extensive experience working with cryptocurrency projects with an audience of >1M active users per day",
};
...
export const VadimGill = {
  ...
  description: `СTO, leads the technology or engineering department in a company and is responsible for developing technological processes. 
