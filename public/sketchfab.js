!(function (t, e) {
  ...
  return (() => {
          ...
          (this.addEventListener = function (t, i, n) {
            "viewerready" === t && e.isViewerReady && i(),
              ...
              n &&
                ...
                ((n.name = t), this.setListenerOptions(n));
          }),
        ...
        if (!this._serverReceiveMessageBinded) {
          ...
          (this._serverReceiveMessageBinded = function (e) {
            ...
            window.addEventListener(
              "message",
              this._serverReceiveMessageBinded
            );
        }
      },
    };
    ...
    d.prototype = {
      _urlOptionsDict: {
        skfb_api_version: { default: "1.12.0", type: "string" },
      },
      _optionsLoaded: function (t) {
        (this._urlOptions = t),
          (this._version = this._getURLOption(
            "skfb_api_version",
            this._version
          ));
      },
      ...
      _realInit: function () {
        this._initializeAPIEmbedBinded ||
          (this._initializeAPIEmbedBinded =
            this._initializeAPIEmbed.bind(this)),
      ...
      success: function (t) {
        this._options.success &&
          "function" == typeof this._options.success &&
          this._options.success(t);
      },
      error: function (t) {
        this._options.error &&
          "function" == typeof this._options.error &&
          this._options.error(t);
      },
      show: function () {
